...
function consumoAPI(
  urlApi = "https://rickandmortyapi.com/api/character?page=1",
  tipo = "normal"
) {
  if (tipo != "normal") {
          ...
          divGrilla.innerHTML += `
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title pe-4">${personaje.name}</h5>
                            <div>
                                <div><i class="fa-solid fa-user-large"></i> ${personaje.species}</div>
                                <div>
                                    <i class="fa-solid fa-heart iconPer"></i>
                                    <div class="estadoPersonaje ${claseEstado}"></div>
                                    ${personaje.status}</div>
                                <div><i class="fa-solid fa-mars-and-venus-burst"></i> ${personaje.gender}</div>
                            </div>
                        </div>
                    </div>
                </div>
